...
public final class ModBlocks {
    ...
    public static final DeferredBlock<Block> ERVANIUM_ORE = BLOCKS.register("ervanium_ore", kimlik -> new Block(ozellik(Blocks.END_STONE, kimlik).requiresCorrectToolForDrops().destroyTime(8.0F).explosionResistance(9.0F).lightLevel(durum -> 3)));
